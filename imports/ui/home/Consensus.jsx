                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Row>
                                                    ...
                                                    <Col md={12} xs={8}><span className="value"><Link style={{ color: "#000000" }} to={"/validator/" + validatorOperatorAddress} ><Avatar moniker={moniker} profileUrl={profileUrl} address={this.props?.consensus?.proposerAddress} list={true} />{moniker}</Link></span></Col>
                                                </Row>
                                            </Col>
                                        </Row>
                                    </Col>

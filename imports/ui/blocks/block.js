    ...
    render() {
        ...
        if (proposer){
            ...
            return <Row className="block-info">
                ...
                <Col xs={8} sm={3} md={2} lg={3} className="text-truncate" color="black"><Link color="black" to={"/validator/" + proposerOperatorAddress}><Avatar moniker={moniker} profileUrl={proposer.profile_url} address={proposerOperatorAddress} list={true} /> {moniker}</Link></Col>
